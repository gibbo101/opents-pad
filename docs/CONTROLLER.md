...
1. The sidebar's on-screen size is the zoom baseline's for now. Whether it
   wants a setting of its own, and what size suits the Deck and the
   ultrawide, is for playing to decide.
