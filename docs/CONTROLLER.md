...
1. The rest of the play scheme: sidebar focus on triangle with a highlight over the cameos, R1 with triangle to pin the sidebar; snap to units; R2 with the right stick for zoom once the zoom setting exists, with scatter moving to a tap; a Controls screen diagram in the manner of Retaliation's.
